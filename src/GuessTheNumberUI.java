...
public class GuessTheNumberUI {
    ...
    private JPanel makeCardsPanel(){
        ...
        // HUMAN_PLAY
        // your refactoring should include some changes to the lambda expression in the following line
        ...
        JPanel humanGuessesPanel = new HumanGuessesPanel(cardsPanel, gameResult -> {gameOverPanel.setGameResults(gameResult); gameOverPanel.writeResults();});
